<section class="hero">
  <div class="container">
    <div class="hero-badge-container">
      <div class="hero-badge-download">
        <i class="fas fa-download"></i> Free Version Available Now
      </div>
    ...
    <p class="hero-desc">
      Join our early access program and receive lifetime access to all Pro and
      Agency features of WP-Site-Inspector. No payment required.
    </p>

    <div class="hero-cta">
      <a
        href="https://github.com/prathushan/WP-Site-Inspector/"
        class="btn btn-primary"
      >
        <i class="fab fa-github"></i> Download from GitHub
      </a>
      <a href="#early-access" class="btn btn-outline"
        >Request Early Pro Access</a
      >
    </div>
  </div>
</section>
